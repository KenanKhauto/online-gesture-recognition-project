...
save_path = "/scratch/vihps/vihps14/IPN_Hand/models/resnetl_detector_V3.pth"
#process_id = int(os.environ.get("SLURM_PROCID"))

os.system(f"python ./train/train_detector.py {frames_path} {ann_train} {ann_test} {save_path}")
