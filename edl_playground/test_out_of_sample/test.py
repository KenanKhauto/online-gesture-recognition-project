# based on https://github.com/dougbrion/pytorch-classification-uncertainty/blob/master/test.py
...
def test_single_image(model, img_path, file_name, uncertainty=False, device=None):
